...
public abstract class UsStates {

    private UsStates() { throw new AssertionError("Non Instantiable");}

    public final static String US = "US";

    private final static Map<String, String> mapOfUSStates = new HashMap<String, String>() {
        {
            put("AL", "Alabama");
            put("AK", "Alaska");
            put("AZ", "Arizona");
